...
- **Tier:** 1
- **Slug / route:** `grit`  ->  `/grit`

## Thesis to convey

Sustained passion and perseverance toward long-term goals predicts success better than talent does.

## Signature model

**Grit.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `grit` to done in the registry and DONE in the queue.
