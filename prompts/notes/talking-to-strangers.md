...
- **Tier:** 3
- **Slug / route:** `talking-to-strangers`  ->  `/talking-to-strangers`

## Thesis to convey

We are badly equipped to read people we do not know, and our default assumptions fail in dangerous ways.
...
passes; then flip `talking-to-strangers` to done in the registry and DONE in the queue.
