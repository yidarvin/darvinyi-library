...
- **Tier:** 1
- **Slug / route:** `emotional-intelligence`  ->  `/emotional-intelligence`

## Thesis to convey

Self-awareness, self-regulation, empathy, and social skill often matter more for a life than raw IQ.

## Signature model

**The EI domains.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `emotional-intelligence` to done in the registry and DONE in the queue.
