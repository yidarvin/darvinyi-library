...
- **Tier:** 2
- **Slug / route:** `outlive`  ->  `/outlive`

## Thesis to convey

Living longer and better means shifting medicine from reacting to disease toward preventing it decades early.

## Signature model

**Medicine 3.0.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `outlive` to done in the registry and DONE in the queue.
