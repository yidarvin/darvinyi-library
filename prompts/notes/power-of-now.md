...
- **Tier:** 1
- **Slug / route:** `power-of-now`  ->  `/power-of-now`

## Thesis to convey

Most suffering comes from being lost in thought about past and future; freedom is found in the present moment.
...
passes; then flip `power-of-now` to done in the registry and DONE in the queue.
