...
- **Tier:** 2
- **Slug / route:** `blink`  ->  `/blink`

## Thesis to convey

Snap judgments made in an instant can be as good as, and sometimes better than, careful analysis, but they also fail in specific ways.

## Signature model

**Thin-slicing.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `blink` to done in the registry and DONE in the queue.
