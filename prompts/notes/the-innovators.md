...
- **Tier:** 3
- **Slug / route:** `the-innovators`  ->  `/the-innovators`

## Thesis to convey

The digital revolution was made by collaboration across generations, not by lone geniuses.
...
passes; then flip `the-innovators` to done in the registry and DONE in the queue.
