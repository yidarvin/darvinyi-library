...
- **Tier:** 2
- **Slug / route:** `daily-stoic`  ->  `/daily-stoic`

## Thesis to convey

A year of short Stoic meditations turning ancient philosophy into a daily practice.
...
passes; then flip `daily-stoic` to done in the registry and DONE in the queue.
