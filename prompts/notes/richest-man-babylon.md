...
- **Tier:** 2
- **Slug / route:** `richest-man-babylon`  ->  `/richest-man-babylon`

## Thesis to convey

Timeless money rules told as parables: pay yourself first, live below your means, put money to work.

## Signature model

**Pay yourself first.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `richest-man-babylon` to done in the registry and DONE in the queue.
