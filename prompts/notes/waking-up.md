...
- **Tier:** 3
- **Slug / route:** `waking-up`  ->  `/waking-up`

## Thesis to convey

Spiritual experience and the loss of the sense of self can be explored honestly, without religion.
...
passes; then flip `waking-up` to done in the registry and DONE in the queue.
