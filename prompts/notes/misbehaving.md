...
- **Tier:** 3
- **Slug / route:** `misbehaving`  ->  `/misbehaving`

## Thesis to convey

The story of how economics was forced to admit that real humans, not rational agents, make its decisions.
...
passes; then flip `misbehaving` to done in the registry and DONE in the queue.
