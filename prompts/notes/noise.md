...
- **Tier:** 3
- **Slug / route:** `noise`  ->  `/noise`

## Thesis to convey

Unwanted variability in human judgment is a huge, hidden source of error, distinct from bias and just as costly.
...
passes; then flip `noise` to done in the registry and DONE in the queue.
