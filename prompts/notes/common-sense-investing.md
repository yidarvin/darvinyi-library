...
- **Tier:** 2
- **Slug / route:** `common-sense-investing`  ->  `/common-sense-investing`

## Thesis to convey

Owning the whole market cheaply and holding forever beats trying to beat it.

## Signature model

**Index investing.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `common-sense-investing` to done in the registry and DONE in the queue.
