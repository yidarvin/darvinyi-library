...
- **Tier:** 1
- **Slug / route:** `peak`  ->  `/peak`

## Thesis to convey

Expertise is not a gift but the product of deliberate practice: focused, effortful, feedback-driven work at the edge of ability.

## Signature model

**Deliberate practice.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `peak` to done in the registry and DONE in the queue.
