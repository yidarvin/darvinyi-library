...
- **Tier:** 3
- **Slug / route:** `godel-escher-bach`  ->  `/godel-escher-bach`

## Thesis to convey

Mind and meaning emerge from self-reference and strange loops, patterns shared by logic, art, and music.

## Signature model

**Strange loops.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `godel-escher-bach` to done in the registry and DONE in the queue.
