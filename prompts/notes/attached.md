...
- **Tier:** 3
- **Slug / route:** `attached`  ->  `/attached`

## Thesis to convey

Adult attachment styles, secure, anxious, and avoidant, quietly shape how our relationships work.

## Signature model

**Attachment styles.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `attached` to done in the registry and DONE in the queue.
