...
- **Tier:** 3
- **Slug / route:** `talk-to-someone`  ->  `/talk-to-someone`

## Thesis to convey

Seen from both chairs, therapy reveals how change actually happens and how universal our struggles are.
...
passes; then flip `talk-to-someone` to done in the registry and DONE in the queue.
