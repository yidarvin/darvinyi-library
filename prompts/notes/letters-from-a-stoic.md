...
- **Tier:** 2
- **Slug / route:** `letters-from-a-stoic`  ->  `/letters-from-a-stoic`

## Thesis to convey

Warm, practical letters on time, wealth, fear, and death from a Stoic who lived at the center of power.
...
passes; then flip `letters-from-a-stoic` to done in the registry and DONE in the queue.
