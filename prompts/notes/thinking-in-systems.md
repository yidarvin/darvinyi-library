...
- **Year:** 2008
- **Shelf:** Systems, Complexity & the Future
- **Tier:** 1
- **Slug / route:** `thinking-in-systems`  ->  `/thinking-in-systems`

## Thesis to convey

Most problems are system problems, and learning to see stocks, flows, and feedback loops reveals where real leverage lies.

## Signature model

**Stocks, flows, feedback, leverage points.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `thinking-in-systems` to done in the registry and DONE in the queue.
