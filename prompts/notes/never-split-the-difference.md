...
- **Shelf:** Negotiation
- **Tier:** 1
- **Slug / route:** `never-split-the-difference`  ->  `/never-split-the-difference`

## Thesis to convey

Negotiation is emotional, not logical; win by making the other side feel understood through tactical empathy.

## Signature model

**Mirroring, labeling, calibrated questions.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `never-split-the-difference` to done in the registry and DONE in the queue.
