...
- **Tier:** 1
- **Slug / route:** `how-to-win-friends`  ->  `/how-to-win-friends`

## Thesis to convey

You move people not by argument but by genuine interest, appreciation, and letting them feel the idea is theirs.
...
passes; then flip `how-to-win-friends` to done in the registry and DONE in the queue.
