...
- **Tier:** 3
- **Slug / route:** `measure-what-matters`  ->  `/measure-what-matters`

## Thesis to convey

Align and stretch an organization by setting ambitious objectives paired with measurable key results.

## Signature model

**OKRs.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `measure-what-matters` to done in the registry and DONE in the queue.
