...
- **Tier:** 2
- **Slug / route:** `made-to-stick`  ->  `/made-to-stick`

## Thesis to convey

Ideas that stick share a recognizable set of traits, and you can engineer those traits on purpose.

## Signature model

**SUCCESs.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `made-to-stick` to done in the registry and DONE in the queue.
