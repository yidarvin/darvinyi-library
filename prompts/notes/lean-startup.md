...
- **Tier:** 1
- **Slug / route:** `lean-startup`  ->  `/lean-startup`

## Thesis to convey

Build startups as experiments: ship a minimal version, measure real behavior, and learn fast enough to change course.

## Signature model

**Build-measure-learn / MVP.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `lean-startup` to done in the registry and DONE in the queue.
