...
- **Year:** 2011
- **Shelf:** Behavioral Science & Decision-Making
- **Tier:** 1
- **Slug / route:** `thinking-fast-and-slow`  ->  `/thinking-fast-and-slow`

## Thesis to convey

Two modes of thought, one fast and intuitive, one slow and deliberate, govern how we judge and decide, and the fast one misleads us in systematic ways.

## Signature model

**System 1 vs. System 2.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `thinking-fast-and-slow` to done in the registry and DONE in the queue.
