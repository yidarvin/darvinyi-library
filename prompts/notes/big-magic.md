...
- **Tier:** 1
- **Slug / route:** `big-magic`  ->  `/big-magic`

## Thesis to convey

Creative living means chasing curiosity instead of fear, and treating inspiration as a partner rather than a burden.
...
passes; then flip `big-magic` to done in the registry and DONE in the queue.
