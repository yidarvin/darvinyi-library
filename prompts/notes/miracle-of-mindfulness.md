...
- **Tier:** 3
- **Slug / route:** `miracle-of-mindfulness`  ->  `/miracle-of-mindfulness`

## Thesis to convey

Even washing the dishes can be a meditation when done with full, gentle awareness.
...
passes; then flip `miracle-of-mindfulness` to done in the registry and DONE in the queue.
