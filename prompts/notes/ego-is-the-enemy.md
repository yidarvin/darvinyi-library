...
- **Tier:** 2
- **Slug / route:** `ego-is-the-enemy`  ->  `/ego-is-the-enemy`

## Thesis to convey

At every stage, aspiration, success, and failure, ego is the enemy, and humility is the discipline that beats it.
...
passes; then flip `ego-is-the-enemy` to done in the registry and DONE in the queue.
