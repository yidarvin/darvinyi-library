...
- **Tier:** 1
- **Slug / route:** `drive`  ->  `/drive`

## Thesis to convey

For anything beyond rote work, real motivation comes from autonomy, mastery, and purpose, not carrots and sticks.

## Signature model

**Autonomy, mastery, purpose.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `drive` to done in the registry and DONE in the queue.
