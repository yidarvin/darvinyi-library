...
- **Tier:** 3
- **Slug / route:** `lost-connections`  ->  `/lost-connections`

## Thesis to convey

Much depression and anxiety stems from disconnection, from meaning, people, and nature, more than from brain chemistry alone.
...
Hari's downplaying of biological and genetic factors is contested by many researchers. Present the social thesis alongside that criticism.
...
passes; then flip `lost-connections` to done in the registry and DONE in the queue.
