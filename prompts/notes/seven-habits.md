...
- **Tier:** 1
- **Slug / route:** `seven-habits`  ->  `/seven-habits`

## Thesis to convey

Lasting effectiveness comes from aligning yourself with timeless principles and working from the inside out, from private character to public collaboration.

## Signature model

**The 7 habits.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `seven-habits` to done in the registry and DONE in the queue.
