...
- **Tier:** 1
- **Slug / route:** `obstacle-is-the-way`  ->  `/obstacle-is-the-way`

## Thesis to convey

Every obstacle contains the way forward if you meet it with clear perception, decisive action, and steady will.

## Signature model

**Perception, action, will.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `obstacle-is-the-way` to done in the registry and DONE in the queue.
