...
- **Tier:** 2
- **Slug / route:** `ultralearning`  ->  `/ultralearning`

## Thesis to convey

You can master hard skills fast through aggressive, self-directed projects built on a few core principles.
...
passes; then flip `ultralearning` to done in the registry and DONE in the queue.
