...
- **Tier:** 1
- **Slug / route:** `steal-like-an-artist`  ->  `/steal-like-an-artist`

## Thesis to convey

Nothing is fully original; creativity is remixing influences you love into something recognizably your own.
...
passes; then flip `steal-like-an-artist` to done in the registry and DONE in the queue.
