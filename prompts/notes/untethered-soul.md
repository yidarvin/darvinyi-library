...
- **Tier:** 2
- **Slug / route:** `untethered-soul`  ->  `/untethered-soul`

## Thesis to convey

You are not the anxious voice in your head but the awareness watching it, and noticing that changes everything.
...
passes; then flip `untethered-soul` to done in the registry and DONE in the queue.
