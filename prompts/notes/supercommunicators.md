...
- **Tier:** 3
- **Slug / route:** `supercommunicators`  ->  `/supercommunicators`

## Thesis to convey

Connection is a learnable skill: recognize what kind of conversation you are in and match it.
...
passes; then flip `supercommunicators` to done in the registry and DONE in the queue.
