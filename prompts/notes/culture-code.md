...
- **Tier:** 3
- **Slug / route:** `culture-code`  ->  `/culture-code`

## Thesis to convey

Strong group cultures are built deliberately through safety, shared vulnerability, and a clear sense of purpose.
...
passes; then flip `culture-code` to done in the registry and DONE in the queue.
