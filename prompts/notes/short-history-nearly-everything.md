...
- **Tier:** 1
- **Slug / route:** `short-history-nearly-everything`  ->  `/short-history-nearly-everything`

## Thesis to convey

The whole sweep of science, from the Big Bang to human origins, told as a curious amateur's grand tour.
...
passes; then flip `short-history-nearly-everything` to done in the registry and DONE in the queue.
