...
- **Tier:** 2
- **Slug / route:** `four-agreements`  ->  `/four-agreements`

## Thesis to convey

Four simple commitments about speech, reaction, and assumption can free you from self-imposed suffering.

## Signature model

**The four agreements.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `four-agreements` to done in the registry and DONE in the queue.
