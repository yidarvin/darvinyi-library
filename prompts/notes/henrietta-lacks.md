...
- **Tier:** 2
- **Slug / route:** `henrietta-lacks`  ->  `/henrietta-lacks`

## Thesis to convey

One woman's cells, taken without consent, transformed medicine and expose the ethics and race at the heart of science.
...
passes; then mark `henrietta-lacks` draft with `python3 scripts/mark.py henrietta-lacks draft`.
