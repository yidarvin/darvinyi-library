...
- **Tier:** 1
- **Slug / route:** `five-love-languages`  ->  `/five-love-languages`

## Thesis to convey

People give and receive love in different primary ways, and mismatched languages feel like absent love.

## Signature model

**The five love languages.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `five-love-languages` to done in the registry and DONE in the queue.
