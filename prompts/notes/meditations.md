...
- **Tier:** 1
- **Slug / route:** `meditations`  ->  `/meditations`

## Thesis to convey

A Roman emperor's private notes on duty, mortality, and mastering the only thing in our control: our own judgments.
...
passes; then flip `meditations` to done in the registry and DONE in the queue.
