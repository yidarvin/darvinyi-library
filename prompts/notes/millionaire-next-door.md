...
- **Tier:** 2
- **Slug / route:** `millionaire-next-door`  ->  `/millionaire-next-door`

## Thesis to convey

Most real millionaires live frugally and invisibly; wealth is what you keep, not what you show.
...
passes; then flip `millionaire-next-door` to done in the registry and DONE in the queue.
