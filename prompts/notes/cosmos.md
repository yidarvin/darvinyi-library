...
- **Tier:** 2
- **Slug / route:** `cosmos`  ->  `/cosmos`

## Thesis to convey

A luminous tour of the universe and our tiny, precious place in it, told through the story of how we came to know it.
...
passes; then flip `cosmos` to done in the registry and DONE in the queue.
