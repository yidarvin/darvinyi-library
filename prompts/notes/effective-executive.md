...
- **Tier:** 2
- **Slug / route:** `effective-executive`  ->  `/effective-executive`

## Thesis to convey

Effectiveness is a habit made of practices: managing time, focusing on contribution, and making decisions that matter.
...
passes; then flip `effective-executive` to done in the registry and DONE in the queue.
