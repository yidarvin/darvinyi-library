...
- **Tier:** 1
- **Slug / route:** `range`  ->  `/range`

## Thesis to convey

In complex, unpredictable fields, broad generalists who sample widely often outperform narrow early specialists.
...
passes; then flip `range` to done in the registry and DONE in the queue.
