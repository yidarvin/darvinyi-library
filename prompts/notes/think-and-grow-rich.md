...
- **Tier:** 2
- **Slug / route:** `think-and-grow-rich`  ->  `/think-and-grow-rich`

## Thesis to convey

Sustained desire, faith, and persistence, organized into definite plans, are the engine behind wealth.
...
Hill's biographical and research claims (the supposed Carnegie commission, the 500 interviews) are historically doubted, and the mechanism is closer to motivation than method. Present as a mindset classic, not evidence.
...
passes; then flip `think-and-grow-rich` to done in the registry and DONE in the queue.
