...
- **Tier:** 3
- **Slug / route:** `silent-spring`  ->  `/silent-spring`

## Thesis to convey

Unchecked pesticide use was poisoning the living world, a warning that launched the modern environmental movement.
...
passes; then flip `silent-spring` to done in the registry and DONE in the queue.
