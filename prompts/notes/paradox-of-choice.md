...
- **Tier:** 2
- **Slug / route:** `paradox-of-choice`  ->  `/paradox-of-choice`

## Thesis to convey

More options can leave us less satisfied and more paralyzed, not freer.

## Signature model

**Choice overload.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `paradox-of-choice` to done in the registry and DONE in the queue.
