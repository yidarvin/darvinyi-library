...
- **Shelf:** Negotiation
- **Tier:** 3
- **Slug / route:** `getting-past-no`  ->  `/getting-past-no`

## Thesis to convey

Break through stonewalling, attacks, and tricks by refusing to react and building the other side a golden bridge.
...
passes; then flip `getting-past-no` to done in the registry and DONE in the queue.
