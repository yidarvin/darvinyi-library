...
- **Tier:** 2
- **Slug / route:** `the-gene`  ->  `/the-gene`

## Thesis to convey

The story of the gene, from Mendel's peas to gene editing, and the promise and peril of rewriting ourselves.
...
passes; then flip `the-gene` to done in the registry and DONE in the queue.
