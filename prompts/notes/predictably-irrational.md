...
- **Tier:** 1
- **Slug / route:** `predictably-irrational`  ->  `/predictably-irrational`

## Thesis to convey

Our irrational choices are not random; they follow predictable patterns we can anticipate.
...
passes; then flip `predictably-irrational` to done in the registry and DONE in the queue.
