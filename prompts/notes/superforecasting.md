...
- **Tier:** 2
- **Slug / route:** `superforecasting`  ->  `/superforecasting`

## Thesis to convey

Forecasting is a skill: ordinary people who think in calibrated probabilities and update often beat experts.
...
passes; then flip `superforecasting` to done in the registry and DONE in the queue.
