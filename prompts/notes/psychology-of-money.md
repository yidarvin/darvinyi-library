...
- **Tier:** 1
- **Slug / route:** `psychology-of-money`  ->  `/psychology-of-money`

## Thesis to convey

Doing well with money has little to do with intelligence and everything to do with behavior, patience, and knowing what enough means.
...
passes; then flip `psychology-of-money` to done in the registry and DONE in the queue.
