...
- **Tier:** 2
- **Slug / route:** `quiet`  ->  `/quiet`

## Thesis to convey

Introverts bring strengths a loud, group-oriented culture overlooks, and honoring them changes how we work and live.
...
passes; then flip `quiet` to done in the registry and DONE in the queue.
