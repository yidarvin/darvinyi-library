...
- **Tier:** 3
- **Slug / route:** `originals`  ->  `/originals`

## Thesis to convey

Original thinkers are not fearless prodigies; they doubt, procrastinate, and hedge, and still manage to champion new ideas.
...
passes; then flip `originals` to done in the registry and DONE in the queue.
