...
- **Shelf:** Negotiation
- **Tier:** 3
- **Slug / route:** `bargaining-for-advantage`  ->  `/bargaining-for-advantage`

## Thesis to convey

Effective negotiation starts from knowing your own style and preparing around a few durable principles.
...
passes; then flip `bargaining-for-advantage` to done in the registry and DONE in the queue.
