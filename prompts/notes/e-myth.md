...
- **Tier:** 2
- **Slug / route:** `e-myth`  ->  `/e-myth`

## Thesis to convey

Most small businesses fail because the owner works in the business as a technician instead of on it as a system.

## Signature model

**Work on it, not in it.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `e-myth` to done in the registry and DONE in the queue.
