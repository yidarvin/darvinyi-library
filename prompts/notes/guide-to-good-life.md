...
- **Tier:** 3
- **Slug / route:** `guide-to-good-life`  ->  `/guide-to-good-life`

## Thesis to convey

A practical modern program of Stoic techniques for reducing anxiety and wanting what you already have.

## Signature model

**Negative visualization.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `guide-to-good-life` to done in the registry and DONE in the queue.
