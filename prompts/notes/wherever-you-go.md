...
- **Year:** 1994
- **Shelf:** Spirituality & Mindfulness
- **Tier:** 2
- **Slug / route:** `wherever-you-go`  ->  `/wherever-you-go`

## Thesis to convey

Mindfulness is simply paying full attention to the present, on purpose and without judgment, and it can be practiced anywhere.
...
passes; then flip `wherever-you-go` to done in the registry and DONE in the queue.
