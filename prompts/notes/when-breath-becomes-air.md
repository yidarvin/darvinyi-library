...
- **Tier:** 3
- **Slug / route:** `when-breath-becomes-air`  ->  `/when-breath-becomes-air`

## Thesis to convey

A young neurosurgeon facing terminal cancer asks what makes a life worth living when time runs short.
...
passes; then flip `when-breath-becomes-air` to done in the registry and DONE in the queue.
