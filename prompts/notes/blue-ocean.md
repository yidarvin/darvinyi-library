...
- **Tier:** 2
- **Slug / route:** `blue-ocean`  ->  `/blue-ocean`

## Thesis to convey

Stop fighting in bloody red oceans of competition and create uncontested new market space instead.

## Signature model

**Red vs. blue oceans.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `blue-ocean` to done in the registry and DONE in the queue.
