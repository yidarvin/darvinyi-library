...
- **Tier:** 2
- **Slug / route:** `fifth-discipline`  ->  `/fifth-discipline`

## Thesis to convey

Organizations thrive when they learn, and systems thinking is the discipline that binds the others together.

## Signature model

**The learning organization.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `fifth-discipline` to done in the registry and DONE in the queue.
