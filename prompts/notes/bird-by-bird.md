...
- **Author:** Anne Lamott
- **Year:** 1994
- **Shelf:** Creativity & Writing
- **Tier:** 2
- **Slug / route:** `bird-by-bird`  ->  `/bird-by-bird`

## Thesis to convey

You get through writing, and life, one small piece at a time, and you give yourself permission to write badly first.

## Signature model

**Shitty first drafts.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `bird-by-bird` to done in the registry and DONE in the queue.
