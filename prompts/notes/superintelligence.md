...
- **Tier:** 3
- **Slug / route:** `superintelligence`  ->  `/superintelligence`

## Thesis to convey

If machine intelligence surpasses ours, controlling it becomes the defining challenge, and we are unprepared.

## Signature model

**The control problem.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `superintelligence` to done in the registry and DONE in the queue.
