...
- **Tier:** 3
- **Slug / route:** `i-will-teach-you`  ->  `/i-will-teach-you`

## Thesis to convey

Automate a simple system for spending, saving, and investing, then spend guilt-free on what you love.

## Signature model

**Automated personal finance.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `i-will-teach-you` to done in the registry and DONE in the queue.
