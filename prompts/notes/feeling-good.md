...
- **Tier:** 2
- **Slug / route:** `feeling-good`  ->  `/feeling-good`

## Thesis to convey

Moods follow thoughts, and learning to catch and correct distorted thinking can lift depression without drugs.

## Signature model

**Cognitive distortions.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `feeling-good` to done in the registry and DONE in the queue.
