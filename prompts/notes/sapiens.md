...
- **Tier:** 1
- **Slug / route:** `sapiens`  ->  `/sapiens`

## Thesis to convey

Homo sapiens conquered the world because we alone cooperate flexibly in huge numbers around shared fictions like money, nations, and rights.

## Signature model

**The three revolutions.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
Harari's sweeping synthesis draws sharp criticism from specialists for overstatement and factual slips. Present the big-picture argument while noting scholars contest specific claims.
...
passes; then flip `sapiens` to done in the registry and DONE in the queue.
