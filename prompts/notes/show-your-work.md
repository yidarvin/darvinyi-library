...
- **Tier:** 3
- **Slug / route:** `show-your-work`  ->  `/show-your-work`

## Thesis to convey

Get discovered by sharing your process openly and generously, not by hoarding finished work.
...
passes; then flip `show-your-work` to done in the registry and DONE in the queue.
