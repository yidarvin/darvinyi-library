...
- **Tier:** 2
- **Slug / route:** `flourish`  ->  `/flourish`

## Thesis to convey

Well-being is more than happiness; it is built from positive emotion, engagement, relationships, meaning, and accomplishment.

## Signature model

**PERMA.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `flourish` to done in the registry and DONE in the queue.
