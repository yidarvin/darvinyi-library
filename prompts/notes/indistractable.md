...
- **Tier:** 3
- **Slug / route:** `indistractable`  ->  `/indistractable`

## Thesis to convey

Distraction starts inside us; master the internal triggers and the external ones lose their grip.
...
passes; then flip `indistractable` to done in the registry and DONE in the queue.
