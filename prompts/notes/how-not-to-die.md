...
- **Tier:** 3
- **Slug / route:** `how-not-to-die`  ->  `/how-not-to-die`

## Thesis to convey

Diet is the biggest lever against the diseases most likely to kill us, and the evidence points toward whole plant foods.
...
Greger presents a strongly pro-plant case and some critics argue the evidence is read selectively. Present the dietary argument as one well-supported view, not settled fact.
...
passes; then flip `how-not-to-die` to done in the registry and DONE in the queue.
