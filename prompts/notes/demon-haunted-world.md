...
- **Tier:** 3
- **Slug / route:** `demon-haunted-world`  ->  `/demon-haunted-world`

## Thesis to convey

Science is a candle in the dark, and skeptical thinking is our best defense against superstition and deception.

## Signature model

**The baloney detection kit.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `demon-haunted-world` to done in the registry and DONE in the queue.
