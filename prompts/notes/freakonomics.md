...
- **Tier:** 1
- **Slug / route:** `freakonomics`  ->  `/freakonomics`

## Thesis to convey

If you follow the incentives, the hidden side of everyday life starts to make surprising sense.

## Signature model

**Incentives.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `freakonomics` to done in the registry and DONE in the queue.
