...
- **Year:** 2014
- **Shelf:** Learning & Skill Acquisition
- **Tier:** 3
- **Slug / route:** `mind-for-numbers`  ->  `/mind-for-numbers`

## Thesis to convey

Learning hard subjects gets easier when you alternate focused effort with diffuse rest and work with how the brain actually learns.

## Signature model

**Focused vs. diffuse thinking.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `mind-for-numbers` to done in the registry and DONE in the queue.
