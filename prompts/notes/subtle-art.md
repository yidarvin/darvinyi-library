...
- **Tier:** 1
- **Slug / route:** `subtle-art`  ->  `/subtle-art`

## Thesis to convey

A good life comes from choosing what to care about, accepting struggle, and dropping the demand to feel good all the time.
...
passes; then flip `subtle-art` to done in the registry and DONE in the queue.
