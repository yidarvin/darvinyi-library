...
- **Tier:** 2
- **Slug / route:** `dare-to-lead`  ->  `/dare-to-lead`

## Thesis to convey

Courageous leadership is built on vulnerability, clear values, and trust, not armor and authority.
...
passes; then flip `dare-to-lead` to done in the registry and DONE in the queue.
