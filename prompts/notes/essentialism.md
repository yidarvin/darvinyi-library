...
- **Tier:** 2
- **Slug / route:** `essentialism`  ->  `/essentialism`

## Thesis to convey

Doing less but better, by disciplined pursuit of only what is essential, beats doing more of everything.
...
passes; then flip `essentialism` to done in the registry and DONE in the queue.
