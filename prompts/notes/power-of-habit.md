...
- **Tier:** 1
- **Slug / route:** `power-of-habit`  ->  `/power-of-habit`

## Thesis to convey

Habits run on a simple neurological loop, and understanding that loop is how you change them.

## Signature model

**The habit loop.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `power-of-habit` to done in the registry and DONE in the queue.
