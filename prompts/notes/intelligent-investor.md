...
- **Tier:** 1
- **Slug / route:** `intelligent-investor`  ->  `/intelligent-investor`

## Thesis to convey

Invest with a margin of safety and treat the market as a moody business partner, not a signal to obey.

## Signature model

**Mr. Market / margin of safety.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `intelligent-investor` to done in the registry and DONE in the queue.
