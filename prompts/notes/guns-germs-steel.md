...
- **Tier:** 1
- **Slug / route:** `guns-germs-steel`  ->  `/guns-germs-steel`

## Thesis to convey

The broad shape of history was set by geography and biology, not by any innate differences between peoples.

## Signature model

**Geographic determinism.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
Many anthropologists and historians consider the thesis overly deterministic and selective. Present the argument alongside the specialist critique.
...
passes; then flip `guns-germs-steel` to done in the registry and DONE in the queue.
