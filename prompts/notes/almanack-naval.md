...
- **Tier:** 2
- **Slug / route:** `almanack-naval`  ->  `/almanack-naval`

## Thesis to convey

Build wealth through leverage and specific knowledge, and pursue happiness as a skill, not a destination.

## Signature model

**Leverage and specific knowledge.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `almanack-naval` to done in the registry and DONE in the queue.
