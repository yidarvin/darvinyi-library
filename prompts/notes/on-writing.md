...
- **Tier:** 1
- **Slug / route:** `on-writing`  ->  `/on-writing`

## Thesis to convey

Good writing is a craft learned by reading widely, writing daily, and cutting without mercy, told through one writer's life.
...
passes; then flip `on-writing` to done in the registry and DONE in the queue.
