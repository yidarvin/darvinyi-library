...
- **Tier:** 3
- **Slug / route:** `astrophysics-hurry`  ->  `/astrophysics-hurry`

## Thesis to convey

The essentials of the cosmos, from the Big Bang to dark matter, in brisk and vivid brief chapters.
...
passes; then flip `astrophysics-hurry` to done in the registry and DONE in the queue.
