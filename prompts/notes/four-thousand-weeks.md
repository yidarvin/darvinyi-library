...
- **Tier:** 2
- **Slug / route:** `four-thousand-weeks`  ->  `/four-thousand-weeks`

## Thesis to convey

A human life is absurdly short, and accepting that finitude, rather than fighting it with productivity, is the real task.
...
passes; then flip `four-thousand-weeks` to done in the registry and DONE in the queue.
