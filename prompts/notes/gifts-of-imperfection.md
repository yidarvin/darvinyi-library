...
- **Tier:** 3
- **Slug / route:** `gifts-of-imperfection`  ->  `/gifts-of-imperfection`

## Thesis to convey

Wholehearted living means letting go of who you think you should be and embracing worthiness as you are.
...
passes; then flip `gifts-of-imperfection` to done in the registry and DONE in the queue.
