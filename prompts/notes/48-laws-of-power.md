...
- **Tier:** 3
- **Slug / route:** `48-laws-of-power`  ->  `/48-laws-of-power`

## Thesis to convey

Power follows observable, often ruthless laws, drawn from history, whether or not you choose to play by them.
...
An amoral catalog of manipulation presented descriptively. Frame as a lens on power dynamics, not an endorsement of the tactics.
...
passes; then flip `48-laws-of-power` to done in the registry and DONE in the queue.
