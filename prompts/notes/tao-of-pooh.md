...
- **Tier:** 3
- **Slug / route:** `tao-of-pooh`  ->  `/tao-of-pooh`

## Thesis to convey

The principles of Taoism, explained through the effortless wisdom of Winnie-the-Pooh.
...
passes; then flip `tao-of-pooh` to done in the registry and DONE in the queue.
