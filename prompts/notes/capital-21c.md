...
- **Tier:** 3
- **Slug / route:** `capital-21c`  ->  `/capital-21c`

## Thesis to convey

When returns on capital outrun economic growth, wealth concentrates and inequality widens.

## Signature model

**r > g.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `capital-21c` to done in the registry and DONE in the queue.
