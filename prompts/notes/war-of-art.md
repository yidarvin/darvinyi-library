...
- **Tier:** 2
- **Slug / route:** `war-of-art`  ->  `/war-of-art`

## Thesis to convey

A hidden force called Resistance sabotages every creative act, and beating it means simply turning pro and showing up.

## Signature model

**Resistance.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `war-of-art` to done in the registry and DONE in the queue.
