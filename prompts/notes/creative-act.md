...
- **Tier:** 3
- **Slug / route:** `creative-act`  ->  `/creative-act`

## Thesis to convey

Creativity is a way of being, a practice of paying attention and getting out of the work's way.
...
passes; then flip `creative-act` to done in the registry and DONE in the queue.
