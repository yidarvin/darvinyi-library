...
- **Tier:** 1
- **Slug / route:** `good-to-great`  ->  `/good-to-great`

## Thesis to convey

Companies leap from good to great through humble, willful leadership, disciplined focus, and momentum that builds like a flywheel.

## Signature model

**Level 5 Leadership / Hedgehog / Flywheel.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `good-to-great` to done in the registry and DONE in the queue.
