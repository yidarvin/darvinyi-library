...
- **Tier:** 3
- **Slug / route:** `art-of-war`  ->  `/art-of-war`

## Thesis to convey

The highest skill is to win without fighting, through preparation, positioning, and knowing yourself and your rival.
...
passes; then flip `art-of-war` to draft in the registry. The queue remains PENDING until an
independent critic approves it.
