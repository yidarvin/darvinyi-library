...
- **Tier:** 1
- **Slug / route:** `mindset`  ->  `/mindset`

## Thesis to convey

Believing ability is fixed or growable changes how you face challenge, effort, and failure, and shapes what you achieve.

## Signature model

**Fixed vs. growth mindset.** Render this as the hero diagram in the Model section, in house style, as an original recreation of the idea (never a trace of the book's own figure).
...
passes; then flip `mindset` to done in the registry and DONE in the queue.
