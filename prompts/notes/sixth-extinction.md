...
- **Tier:** 3
- **Slug / route:** `sixth-extinction`  ->  `/sixth-extinction`

## Thesis to convey

Humanity is driving a mass extinction on the scale of the great die-offs of deep time.
...
passes; then flip `sixth-extinction` to done in the registry and DONE in the queue.
